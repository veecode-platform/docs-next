...
- Publish the frontend plugin to Verdaccio (as described [here](/devportal/v1/plugins/development/packaging#publish-a-dynamic-plugin))
...
Do not forget to [package and publish the frontend plugin to Verdaccio](/devportal/v1/plugins/development/packaging#publish-a-dynamic-plugin).
