...
To enable a specific plugin, add it under the includes list or reference a custom manifest. See the [dynamic plugins documentation](/devportal/v1/concepts/dynamic-plugins) for details.
