...
```yaml
plugins:
  - package: oci://${PLUGIN_REGISTRY}/backstage-community-plugin-jenkins-backend:bs_1.52.0__0.27.0
    disabled: false
    pluginConfig:
      jenkins:
        instances:
  ...
  - package: oci://${PLUGIN_REGISTRY}/backstage-community-plugin-jenkins:bs_1.52.0__0.30.0
    disabled: false
    pluginConfig:
      dynamicPlugins:
        frontend:
