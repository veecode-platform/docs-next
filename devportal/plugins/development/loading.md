...
```yaml
plugins:
  - package: oci://quay.io/veecode/backstage-community-plugin-sonarqube-backend:bs_1.52.0__1.1.1
    disabled: false
...
```yaml
plugins:
  - package: oci://quay.io/veecode/backstage-community-plugin-sonarqube:bs_1.52.0__1.1.0
    disabled: false
